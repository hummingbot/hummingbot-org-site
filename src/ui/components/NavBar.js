...
import { P, Body, Bold } from '@hummingbot/hbui/elements/typography'
...
import ThemeToggle from '@hummingbot/hbui/system/ThemeToggle'
...
const NavBarRoot = styled.div(({ isUppercase, isDisabled }) => [
  ...
  tw`relative py-2 pl-5 pr-2 md:pl-12 md:pr-4`,
