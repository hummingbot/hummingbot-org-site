...
function HummingbotLogo(props) {
  return (
    ...
    >
      ...
      ></path>
      <path
        fill={props.bw ? bwColors.b : primaryColors.b}
        fillRule="evenodd"
      ...
      ></path>
      <path
        fill={props.bw ? bwColors.c : primaryColors.c}
        fillRule="evenodd"
      ...
      ></path>
      <path
        fill={props.bw ? bwColors.d : primaryColors.d}
        fillRule="evenodd"
      ...
      ></path>
      <path
        fill={props.bw ? bwColors.e : primaryColors.e}
        fillOpacity="0.84"
        fillRule="evenodd"
      ...
      ></path>
      <path
        fill={props.bw ? bwColors.f : primaryColors.f}
        fillRule="evenodd"
